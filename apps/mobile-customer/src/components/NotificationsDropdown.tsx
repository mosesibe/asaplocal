...
// Ports apps/web/components/notification-bell.tsx's dropdown behavior — a
// panel anchored under the bell icon, not a routed page (the earlier
// /notifications screen was a real mismatch: web never navigates anywhere
// for this).
