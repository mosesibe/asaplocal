 ...
 */
const PUBLIC_PREFIXES = ["/", "/search", "/api/search", "/providers", "/api/providers", "/jobs/new", "/api/jobs/suggest", "/api/ai-buddy", "/api/geo", "/api/categories", "/login", "/register", "/forgot-password", "/reset-password", "/verify-email", "/references", "/api/references", "/api/webhooks", "/api/auth", "/api/mobile/auth", "/sitemap.xml", "/robots.txt", "/how-it-works", "/pricing", "/about", "/trust-safety", "/terms", "/privacy", "/unsubscribe"];
