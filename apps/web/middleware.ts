 ...
 */
const PUBLIC_PREFIXES = ["/", "/search", "/providers", "/jobs/new", "/api/jobs/suggest", "/api/ai-buddy", "/api/geo", "/login", "/register", "/forgot-password", "/reset-password", "/verify-email", "/references", "/api/references", "/api/webhooks", "/api/auth", "/sitemap.xml", "/robots.txt", "/how-it-works", "/pricing", "/about", "/trust-safety", "/terms", "/privacy"];
