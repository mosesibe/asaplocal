...
export default function RegisterScreen() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    if (!existingCustomer) {
      ...
      if (!termsAccepted) return setError('You must agree to the Terms & Conditions, Professional Terms, Community & Safety Policy, and Privacy Policy.');
              ...
              <>
                ...
                <Pressable style={s.checkboxRow} onPress={() => setTermsAccepted((v) => !v)}>
                  ...
                  <Text style={s.checkboxLabel}>
                    ...
                    ,{' '}
                    <Text style={s.checkboxLink} onPress={() => openWebPage('/terms/professionals')}>
                      Professional Terms
                    </Text>
                    ,{' '}
                    <Text style={s.checkboxLink} onPress={() => openWebPage('/community')}>
