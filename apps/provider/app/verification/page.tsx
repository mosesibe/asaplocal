...
export default async function VerificationCenterPage() {
  ...
  const business = await prisma.business.findUnique({
    ...
    include: { identityVerification: true, insurancePolicies: true, qualifications: true, portfolioItems: true },
  });
  ...
  const sections = [
    ...
    { href: "/verification/qualifications", label: "Qualifications", status: business.qualifications.length > 0 ? "PENDING" : null, count: business.qualifications.length },
    ...
    { href: "/references", label: "References", status: null },
  ];
