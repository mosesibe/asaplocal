...
const CATEGORIES: CategoryDef[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Brickwork & masonry", slug: "brickwork-masonry" },
      { name: "Roofing", slug: "roofing" },
      { name: "Windows & doors", slug: "windows-doors" },
      { name: "Rendering & cladding", slug: "rendering-cladding" },
      { name: "Interior renovation", slug: "interior-renovation" },
    ],
  },
  {
    ...
    children: [
      ...
      { name: "Patio & paving installation", slug: "patio-paving-installation" },
      { name: "Driveway installation", slug: "driveway-installation" },
      { name: "Garden walls & brickwork", slug: "garden-walls-brickwork" },
      { name: "Garden rooms & outbuildings", slug: "garden-rooms-outbuildings" },
      { name: "Pergolas & garden structures", slug: "pergolas-garden-structures" },
      { name: "Fencing & gates installation", slug: "fencing-gates-installation" },
      { name: "Turfing & lawn installation", slug: "turfing-lawn-installation" },
      { name: "Garden drainage", slug: "garden-drainage" },
    ],
  },
  {
    name: "Handyman",
